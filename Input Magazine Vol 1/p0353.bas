...
40 a$="1a2s3d4f5g6h7j8k9l0;":poke 54296,15:goto 380
...
100 if k=3 then x=int(rnd(1)*20)+1:print tab(18)"{cyan}A{sh asterisk}S{down}{left*3}{sh -}{green}"mid$(a$,x,1)"{cyan}{sh -}{down}{left*3}Z{sh asterisk}X"
...
540 data r2d2,vic20,com64,1a2b,28.3.67,age16,7up,you2,a37no,1sec
550 data 9h53b,16/92,01.p5v,19to572,step.73,1984,zx81,13/3/84,we4are1
560 data s7t4n,q3c457,a13579z,p14a41,6k82f3,s0x7,so52me,d00r.,6502chip
